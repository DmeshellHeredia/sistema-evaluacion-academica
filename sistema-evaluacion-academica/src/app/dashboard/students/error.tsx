  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 space-y-5 text-center">
      ...
      <div className="space-y-2 max-w-sm">
        <p className="font-semibold text-foreground text-lg">Error en Estudiantes</p>
        <p className="text-sm text-muted-foreground">
          No se pudo cargar la sección de estudiantes. Intenta de nuevo o recarga la página.
        </p>
      </div>
      <button
        onClick={reset}
