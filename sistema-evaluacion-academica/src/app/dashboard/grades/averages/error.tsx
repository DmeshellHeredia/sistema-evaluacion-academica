...
export default function AveragesError({
  error,
  reset,
}: {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 space-y-5 text-center">
      ...
      <div className="space-y-2 max-w-sm">
        <p className="font-semibold text-foreground text-lg">Error en Promedios</p>
        <p className="text-sm text-muted-foreground">
          No se pudo cargar el ranking de promedios. Intenta de nuevo o recarga la página.
        </p>
      </div>
      <button
        onClick={reset}
